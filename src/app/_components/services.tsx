  ...
  return (
    <section id="services" className="bg-white py-16 scroll-mt-24">
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-4xl font-bold mb-12">Nossos Serviços</h2>
        ...
        <div className="relative">
                  ...
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                      ...
                      <a
                        ...
                        className='flex items-center justify-center gap-2 hover:bg-red-500/70 px-4 py-1 rounded-full duration-300'
                      >
          ...
          <button
            className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 cursor-poiter'
            onClick={scrollNext}
          >
