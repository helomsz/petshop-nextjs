...
export function Testimonials() {
  ...
  return (
    <section id="testimonials" className="bg-[#FFD449] py-16 scroll-mt-24">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
            ...
            <div className='flex'>
              {testimonials.map((item, index) => (
                <div key={index} className="flex-[0_0_100%] min-w-0 px-3">
                  <article className="bg-[#1e293b] text-white rounded-3xl p-8 h-full flex flex-col border border-white/5 transition-all duration-300 hover:-translate-y-1">
                    <div className='flex flex-col items-center text-center space-y-4'>
                      <div className=" relative w-24 h-24 rounded-full ring-4 ring-white/10 shadow-lg">
                        <Image
                          src={item.image}
                          alt={item.author}
                          fill
                      ...
                      <p className="text-gray-200 text-base leading-relaxed max-w-xl">{item.content}</p>
                      <div>
          ...
          <button
            className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 shadow-[0_12px_30px_rgba(0,0,0,0.25)] border border-black/5'
            onClick={scrollNext}
          >
